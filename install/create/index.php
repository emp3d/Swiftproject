...
$ip = getRealIP();
    ...
    function createAccount() {
        ...
        $sql5 = "CREATE TABLE swift_servers (id INTEGER NOT NULL AUTO_INCREMENT, name VARCHAR(100), port INTEGER, owner_id INTEGER NOT NULL, host_id INTEGER NOT NULL, account VARCHAR(100), password VARCHAR(100), active TINYINT(1), script VARCHAR(500), PRIMARY KEY(id))";
