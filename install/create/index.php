...
$ip = getRealIP();
    ...
    function createAccount() {
        ...
        $sql5 = "CREATE TABLE swift_servers (id INTEGER NOT NULL AUTO_INCREMENT, name VARCHAR(100), port INTEGER, owner_id INTEGER NOT NULL, host_id INTEGER NOT NULL, account VARCHAR(100), password VARCHAR(100), active TINYINT(1) DEFAULT 1, script VARCHAR(500), pid INTEGER, PRIMARY KEY(id), CONSTRAINT unique_name UNIQUE(name)";
        ...
        $sql7 = "CREATE TABLE swift_hosts (id INTEGER NOT NULL AUTO_INCREMENT, name VARCHAR(100), ip VARCHAR(15) NOT NULL, sshport INTEGER, user VARCHAR(100) NOT NULL, pass VARCHAR(100) NOT NULL, islinux TINYINT(1), PRIMARY KEY(id), CONSTRAINT sw_hunq UNIQUE(ip))";
